...
public class ATM extends ThingamajigsDecorativeBlock {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        pTooltip.add(Component.translatable("block.thingamajigs.atm.desc").withStyle(ChatFormatting.GRAY));
    }
}
