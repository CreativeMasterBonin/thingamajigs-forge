...
public class GrayPumpkinBlock extends DyedPumpkinBlock {
    public GrayPumpkinBlock(BlockBehaviour.Properties p) {
    ...
    public InteractionResult use(BlockState bs, Level lvl, BlockPos bp, Player ply, InteractionHand ih, BlockHitResult bhr) {
        ...
        if (itemstack.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
            if (!lvl.isClientSide) {
                ...
                lvl.setBlock(bp, ThingamajigsBlocks.GRAY_CARVED_PUMPKIN.get().defaultBlockState()
                ...
                ItemEntity itementity = new ItemEntity(lvl,
                        ...
                        new ItemStack(ThingamajigsItems.GRAY_PUMPKIN_SEEDS.get(), 4));
    ...
    public StemBlock getStem() {
        return (StemBlock)ThingamajigsBlocks.GRAY_PUMPKIN_STEM.get();
    }

    @Override
    public AttachedStemBlock getAttachedStem() {
        return (AttachedStemBlock)ThingamajigsBlocks.ATTATCHED_GRAY_PUMPKIN_STEM.get();
    }
}
