...
public class LimePumpkinBlock extends DyedPumpkinBlock {
    public LimePumpkinBlock(Properties p) {
    ...
    public InteractionResult use(BlockState bs, Level lvl, BlockPos bp, Player ply, InteractionHand ih, BlockHitResult bhr) {
        ...
        if (itemstack.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
            if (!lvl.isClientSide) {
                ...
                lvl.setBlock(bp, ThingamajigsBlocks.LIME_CARVED_PUMPKIN.get().defaultBlockState()
                ...
                ItemEntity itementity = new ItemEntity(lvl,
                        ...
                        new ItemStack(ThingamajigsItems.LIME_PUMPKIN_SEEDS.get(), 4));
    ...
    public StemBlock getStem() {
        return (StemBlock)ThingamajigsBlocks.LIME_PUMPKIN_STEM.get();
    }

    @Override
    public AttachedStemBlock getAttachedStem() {
        return (AttachedStemBlock)ThingamajigsBlocks.ATTATCHED_LIME_PUMPKIN_STEM.get();
    }
}
