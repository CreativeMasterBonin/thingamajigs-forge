...
public class BluePumpkinBlock extends DyedPumpkinBlock {
    public BluePumpkinBlock(Properties p) {
    ...
    public InteractionResult use(BlockState bs, Level lvl, BlockPos bp, Player ply, InteractionHand ih, BlockHitResult bhr) {
        ...
        if (itemstack.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
            if (!lvl.isClientSide) {
                ...
                lvl.setBlock(bp, ThingamajigsBlocks.BLUE_CARVED_PUMPKIN.get().defaultBlockState()
                ...
                ItemEntity itementity = new ItemEntity(lvl,
                        ...
                        new ItemStack(ThingamajigsItems.BLUE_PUMPKIN_SEEDS.get(), 4));
    ...
    public StemBlock getStem() {
        return (StemBlock)ThingamajigsBlocks.BLUE_PUMPKIN_STEM.get();
    }

    @Override
    public AttachedStemBlock getAttachedStem() {
        return (AttachedStemBlock)ThingamajigsBlocks.ATTATCHED_BLUE_PUMPKIN_STEM.get();
    }
}
