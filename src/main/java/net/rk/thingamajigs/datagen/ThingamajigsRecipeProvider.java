...
public class ThingamajigsRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> frc) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,ThingamajigsItems.CUSTOMIZATION_TOOL.get().asItem(),1)
                ...
                .save(rc);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,ThingamajigsItems.RENDERING_TOOL.get().asItem(),1)
                .requires(ThingamajigsItems.THINGAMAJIG.get().asItem())
                .requires(ThingamajigsItems.THINGAMAJIG.get().asItem())
                .requires(ThingamajigsItems.THINGAMAJIG.get().asItem())
                .requires(Tags.Items.GLASS_PANES)
                .requires(Tags.Items.GLASS_TINTED)
                .unlockedBy("has_thingy",has(ThingamajigsItems.THINGAMAJIG.get().asItem()))
                .save(rc);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,ThingamajigsItems.RANDOMIZE_AND_RESET_TOOL.get().asItem(),1)
                .requires(ThingamajigsItems.THINGAMAJIG.get().asItem())
                .requires(ThingamajigsItems.THINGAMAJIG.get().asItem())
                .requires(ThingamajigsItems.THINGAMAJIG.get().asItem())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,ThingamajigsBlocks.FALL_WREATH.get().asItem(),1)
                .requires(ItemTags.LEAVES)
