...
public class ThingamajigsBlockModelProvider extends BlockModelProvider {
    ...
    public BlockModelBuilder tubeManBodySection(String tubeManFileName, String bodyTexture, String particleTexture){
        return withExistingParent(tubeManFileName,
                new ResourceLocation("thingamajigs:bases/tube_man_components/tube_man_body_section"))
                .texture("0", new ResourceLocation(bodyTexture))
    ...
    public BlockModelBuilder tubeManHeadSection(String tubeManFileName, String bodyTexture, String sideTexture){
        return withExistingParent(tubeManFileName,
                new ResourceLocation("thingamajigs:bases/tube_man_components/tube_man_head_section"))
                .texture("0", new ResourceLocation(sideTexture))
                .texture("1", new ResourceLocation(bodyTexture))
                .texture("particle", new ResourceLocation(sideTexture));
    }
    ...
    public BlockModelBuilder tubeManCompressed(String tubeManFileName, String baseStandTexture, String bodyTexture, String sideTexture){
        return withExistingParent(tubeManFileName,
                new ResourceLocation("thingamajigs:bases/tube_man_components/tube_man_base_compressed"))
                .texture("0", new ResourceLocation("minecraft","block/blast_furnace_top"))
                .texture("2", new ResourceLocation(bodyTexture))
                .texture("3", new ResourceLocation(sideTexture))
                .texture("particle", new ResourceLocation("minecraft","block/blast_furnace_top"));
    }
