...
public class ShortCarWashBrush extends Block {
    ...
    public ShortCarWashBrush(Properties p) {
        super(p.strength(1f,4f));
    }

    @Override
    public VoxelShape getShape(BlockState state, BlockGetter level, BlockPos pos, CollisionContext context) {
        boolean isHoldingCarWashBrush = context.isHoldingItem(ThingamajigsBlocks.CAR_WASH_MIXED_BRUSH.get().asItem());
