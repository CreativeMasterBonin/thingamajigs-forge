...
public class DJLaserLightBERenderer implements BlockEntityRenderer<DJLaserLightBE> {
    ...
    public void render(DJLaserLightBE be, float ptick, PoseStack pose, MultiBufferSource mbs, int light, int overlay) {
        ...
        if(!be.hidePose){
            ...
            else if(be.laserCount == 2) {
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle - 15, be.ticks, domm, be.verticalAngle, be.oscAngle,be.getBlockPos(),
                        be.vertOscAngle,be.dOfMotMultiVert);
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle + 15, be.ticks, domm, be.verticalAngle, be.oscAngle,be.getBlockPos(),
                        be.vertOscAngle,be.dOfMotMultiVert);
            }
            else if(be.laserCount == 3) {
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle - 15, be.ticks, domm, be.verticalAngle, be.oscAngle,be.getBlockPos(),
                        be.vertOscAngle,be.dOfMotMultiVert);
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
            ...
            else if(be.laserCount == 4) {
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle - 35, be.ticks, domm, be.verticalAngle, be.oscAngle,be.getBlockPos(),
                        be.vertOscAngle,be.dOfMotMultiVert);
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle - 15, be.ticks, domm, be.verticalAngle, be.oscAngle,be.getBlockPos(),
                        be.vertOscAngle,be.dOfMotMultiVert);
            ...
            else if(be.laserCount == 6){
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle - 55, be.ticks, domm, be.verticalAngle, be.oscAngle, be.getBlockPos(),
                        be.vertOscAngle, be.dOfMotMultiVert);
                extendedRenderBeaconBeam(pose, mbs, BEAM_LOCATION, ptick, 1, j, 0,
                        be.height, be.diffuseCol, be.laserSize, be.angle - 35, be.ticks, domm, be.verticalAngle, be.oscAngle, be.getBlockPos(),
                        be.vertOscAngle, be.dOfMotMultiVert);
