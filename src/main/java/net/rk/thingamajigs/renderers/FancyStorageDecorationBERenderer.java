...
import net.rk.thingamajigs.entity.customblock.FancyStorageDecorationBE;
...
public class FancyStorageDecorationBERenderer implements BlockEntityRenderer<FancyStorageDecorationBE> {
    ...
    public void render(FancyStorageDecorationBE be, float v, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        if(be.getBlockState().getBlock() instanceof FancyStorageDecoration deco){
            if(be.getBlockState().getBlock() == ThingamajigsBlocks.WHITE_CUBE_SHELF.get()){
                ...
                renderStandalone(45,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(46,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(47,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(48,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(49,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(50,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(51,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(52,-3.6,-0.074,be,poseStack,buffer,packedLight);
                renderStandalone(53,-3.6,-0.074,be,poseStack,buffer,packedLight);
            }
            else if(be.getBlockState().getBlock() == ThingamajigsBlocks.WHITE_SECTIONED_SHELF.get()){
                poseStack.pushPose();
                ...
                poseStack.translate(0.82,0.55,2.5);
                renderItem(be.getItem(0),be,poseStack,buffer,packedLight);

                poseStack.translate(1.3,0,0);
                renderItem(be.getItem(1),be,poseStack,buffer,packedLight);

                poseStack.translate(0.0,1.42,0);
                renderItem(be.getItem(2),be,poseStack,buffer,packedLight);

                poseStack.translate(-1.3,0,0);
                renderItem(be.getItem(3),be,poseStack,buffer,packedLight);

                poseStack.translate(0.65,-1.35,-1);
                renderItem(be.getItem(4),be,poseStack,buffer,packedLight);
                poseStack.popPose();
            }
        }
    }
