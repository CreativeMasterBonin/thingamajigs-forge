...
public class CleverBlackboardModel extends Model{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Thingamajigs.MOD_ID, "textures/entity/clever_blackboard.png"), "main");
