...
public class RRArmModel extends Model{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/rr_arm.png"), "main");
    ...
    @Override
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int i1, int i2, float f1, float f2, float f3, float f4) {
        this.main.render(poseStack,vertexConsumer,i1,i2);
    }
