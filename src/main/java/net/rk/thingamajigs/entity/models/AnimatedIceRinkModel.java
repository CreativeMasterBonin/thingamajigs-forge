...
public class AnimatedIceRinkModel extends Model {
    ...
    /**
     * Used to animate the model if there is no blockEntity or the data cannot be modified on the blockEntity. Used for item renders.
     * @param rinkAngle The current spinning ice rink angle
     * @param ferrisAngle The ice rink ferris wheel angle
     */
    public void setupAnimNoBE(float rinkAngle, float ferrisAngle){
        this.person1.xScale = 0.002f;
        this.person2.xScale = 0.002f;
        this.person3.xScale = 0.002f;
        this.person4.xScale = 0.002f;
