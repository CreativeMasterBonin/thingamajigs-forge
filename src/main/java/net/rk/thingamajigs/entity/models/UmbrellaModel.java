...
public class UmbrellaModel extends Model{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/umbrella.png"), "main");

    public static final ModelLayerLocation ORANGE = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/orange_umbrella.png"), "main");
    public static final ModelLayerLocation MAGENTA = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/magenta_umbrella.png"), "main");
    public static final ModelLayerLocation LIGHT_BLUE = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/light_blue_umbrella.png"), "main");
    public static final ModelLayerLocation YELLOW = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/yellow_umbrella.png"), "main");
    public static final ModelLayerLocation LIME = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/lime_umbrella.png"), "main");
    public static final ModelLayerLocation PINK = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/pink_umbrella.png"), "main");
    public static final ModelLayerLocation GRAY = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/gray_umbrella.png"), "main");
    public static final ModelLayerLocation LIGHT_GRAY = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/light_gray_umbrella.png"), "main");
    public static final ModelLayerLocation CYAN = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/cyan_umbrella.png"), "main");
    public static final ModelLayerLocation PURPLE = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/purple_umbrella.png"), "main");
    public static final ModelLayerLocation BLUE = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/blue_umbrella.png"), "main");
    public static final ModelLayerLocation BROWN = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/brown_umbrella.png"), "main");
    public static final ModelLayerLocation GREEN = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/green_umbrella.png"), "main");
    public static final ModelLayerLocation RED = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/red_umbrella.png"), "main");
    public static final ModelLayerLocation BLACK = new ModelLayerLocation(
            new ResourceLocation("thingamajigs:textures/entity/black_umbrella.png"), "main");
