...
public class TheaterProjectorModel extends Model{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("thingamajigs:textures/entity/theater_projector.png"), "main");
